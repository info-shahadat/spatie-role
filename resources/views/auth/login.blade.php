...
<!-- Primary Meta Tags -->
<title>Softvence :: Sign in page</title>
                            ...
                            <form method="POST" action="{{ route('login') }}" class="mt-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email" value="{{ old('email') }}" placeholder="example@company.com" required autofocus>
                                    </div>
