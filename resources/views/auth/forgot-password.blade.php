...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Softvence :: Forgot password</title>
                ...
                <div class="row justify-content-center form-bg-image">
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="signin-inner my-3 my-lg-0 bg-white shadow border-0 rounded p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <p class="mb-4">
                                Don't fret! Just type in your email and we will send you a password reset link.
                            </p>
                            ...
                            <form method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        <input type="email" name="email" id="email" class="form-control" value="{{ old('email') }}" placeholder="john@company.com" required autofocus >
                                    </div>
